...
def _(get_or_create_folders):
    ...
    [DATASET_FOLDER, OUT_FOLDER, EMBEDDINGS_FOLDER] = get_or_create_folders(TYPE_OF_DOC, TYPE_OF_FAMILY_MODEL, TYPE_OF_EMBEDDINGS_MODEL)[:3]
    DATASET_FOLDER, OUT_FOLDER, EMBEDDINGS_FOLDER
